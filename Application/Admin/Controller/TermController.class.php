...
class TermController extends AdminbaseController {
	...
	function add_post(){
		if (IS_POST) {
			...
			$_POST['seo_title'] = $category."批发_".$category."供应商_".$category."厂家直销 - ISweek工采网";
			$_POST['seo_keywords'] = $category."厂家直销,".$category."批发,".$category."供应商";
			$_POST['seo_description'] = "ISweek工采网供应".$category."厂家直销代理、".$category."批发、".$category."供应商、".$category."生产厂家批发等综合信息，查询".$category."产品图、产品详细信息请上ISweek";
			//判断是否存在相同路径相同名称的分类
			...
			if ($this->terms_obj->create()) {
				if ($this->terms_obj->save()!==false) {
					...
					if($temp_name2!=$temp_name){
						...
						$seo_title = $category."批发_".$category."供应商_".$category."厂家直销 - ISweek工采网";
						$seo_keywords = $category."厂家直销,".$category."批发,".$category."供应商";
						$seo_description = "ISweek工采网供应".$category."厂家直销代理、".$category."批发、".$category."供应商、".$category."生产厂家批发等综合信息，查询".$category."产品图、产品详细信息请上ISweek";
						$model = M("");
